...
import com.ibm.test.entity.TransactionDetails;
import com.ibm.test.repository.AccountRepository;
import com.ibm.test.repository.TransactionRepository;
...
public class AccountService {
	...
	private boolean isValid(String range,String fromDate,String toDate) throws Exception {
		...
		if(ObjectUtils.isEmpty(toDate)  && (ObjectUtils.isEmpty(fromDate) || ObjectUtils.isEmpty(toDate)  ))
		{
